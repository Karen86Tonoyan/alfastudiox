...
import {
  ...
  Lightbulb, Users, Clapperboard, Brain, Workflow, PenTool, Network, Settings2, Cpu, Boxes, ListChecks
} from "lucide-react";
...
const navItems = [
  { title: "Control Center", path: "/", icon: LayoutDashboard, highlight: true, adminOnly: false },
  ...
  { title: "Photo Studio", path: "/studio", icon: Camera, highlight: true, adminOnly: false },
