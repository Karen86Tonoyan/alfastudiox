...
import { startClusterStateRuntime } from "./lib/runtime/clusterState";
...
function AuthGuard({ children }: { children: React.ReactNode }) {
  ...
  if (LOCAL_OPERATOR_MODE) return <>{children}</>;
...
const App = () => {
  useEffect(() => {
    const stop = startClusterStateRuntime();
    return stop;
  }, []);
