...
export default function ProvidersPage() {
  ...
  const [comfyUrl, setComfyUrl] = useState(comfyApi.baseUrl);
            ...
            <div className="p-4 space-y-3">
              ...
              {comfyUrl.includes("localhost") && (
                <div className="rounded bg-primary/5 border border-primary/20 p-2.5 text-[10px] text-muted-foreground space-y-1">
                  ...
                  <p>1. Uruchom tunel: <span className="font-mono text-primary">ngrok http 8000</span></p>
              ...
              <div className="rounded bg-secondary/30 p-2.5 text-[10px] text-muted-foreground space-y-1">
                ...
                <p>3. Domyślny port desktopowego ComfyUI: <span className="font-mono text-primary">8000</span> (WebSocket + REST)</p>
                <p>4. Sprawdź w przeglądarce: <span className="font-mono text-primary">http://127.0.0.1:8000</span></p>
              </div>
