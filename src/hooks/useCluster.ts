...
export function useCluster() {
  ...
  return {
    ...
    pauseNode: clusterManager.pauseNode.bind(clusterManager),
    drainJobs: clusterManager.drainJobs.bind(clusterManager),
    resumeNode: clusterManager.resumeNode.bind(clusterManager),
    upgradeRuntimeLevel: clusterManager.upgradeRuntimeLevel.bind(clusterManager),
